...
<div class="card">
    ...
    <form action="/electric-use-add-process" method="post" class="needs-validation" novalidate="">
        @csrf
        <div class="card-body form">
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="date" name="date" required value="{{now()->format('Y-m-d')}}" id="date" class="form-control" max="{{now()->format('Y-m-d')}}">
                </div>
            </div>
                ...
                success: function(response) {
                    ...
                    for (const key in response) {
                        if (response[key]['qty'] > 0) {
                            ...
                            html+='<td>';
                            html+='<select name="qty_type[]" id="qty_type_'+count+'" required class="form-control">';
                            ...
                            html +='<td style="text-align: center;"><button class="btn btn-danger" onclick="remove_fun(' +count + ','+product+')" type="button"><i class="fas fa-times"></i></button></td>';
                            html += '</tr>';
                        }
                    }
