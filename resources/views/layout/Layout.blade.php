...
<head>
  ...
  <link rel='shortcut icon' type='image/x-icon' href='{{ url("/assets/img/favicon1.jpg")}}' />
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="#"> <img alt="image" src="/assets/img/electrical.jpg" class="header-logo" style="width: 70px; height:100%; margin:10px auto;"/> 
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown @yield('','') @yield('purchase_order','') @yield('perchased_item','') @yield('permanent_assets','')">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Purchase</span></a>
              <ul class="dropdown-menu">
                <li class="@yield('','')"><a class="nav-link" href="/PurchaseRequestShow">Purchase Order Request</a></li>
            ...
            <li class="dropdown @yield('purchase_order_request_report','') @yield('purchase_order_report','') @yield('purchase_item_report','') @yield('indoor_return_report','') @yield('outdoor_return_report','') @yield('indoor_transfer_report','') @yield('equipment_transfer_report','') @yield('permanent_assets_report','') @yield('expery_date_report','')">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i  data-feather="chevrons-down"></i><span>Reports</span></a>
              <ul class="dropdown-menu">
                ...
                <li class="@yield('expery_date_report','')"><a class="nav-link" href="/expery-date-report">Expiry Date Report</a></li>
              </ul>
            </li>
