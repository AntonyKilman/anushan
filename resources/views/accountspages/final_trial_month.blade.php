...
@section('Accounts Final Trial Month', 'active')
                    ...
                    <div class="card">
                        <div class="pb-0">
                            <div class="card-header-bank">
                                <h4 class="header p-4">
                                    Final Trial Balance Report - Month
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <form action="/Accounts/FinalTrialBalanceMonth" method="get">
                                @csrf
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label>From :</label>
                                            <input type="month" class="form-control " max="{{now()->format('Y-m')}}" name="month" id="month"
                                                value="{{ $month }}">
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive" id="printtrialBalanceTable">
                                <h6
                                    ...
                                    JAFFNA. <br>
                                    TRIAL BALANCE ({{ date('d/m/Y', strtotime($month_start_date)) }} -
                                    {{ date('d/m/Y', strtotime($month_end_date)) }})
                                </h6>
                                <table class="account">
                                    <thead>
                                        <tr class="tdcenter">
                                        ...
                                        <tr>
                                            <td class="accountTd tdcenter">{{ $i++ }}</td>
                                            <td class="accountTd"> Stock {{ date('d/m/Y', strtotime($month_start_date)) }}
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="accountTd tdcenter tdright"></td>
                                            <td class="tdWidth accountTd borderTd tdright">{{ number_format($Accounting_Exp, 2) }}
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="accountTd tdcenter tdright"></td>
                                            <td class="tdWidth accountTd tdright" style="color: green">{{ number_format($total_debit, 2) }}</td>
                                            <td class="tdWidth  tdright accountTd" style="color: green">{{ number_format($total_credit, 2) }}</td>
                                        </tr>
