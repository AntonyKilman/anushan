...
@section('other_income_categeory', 'active')
@section('content')
                            ...
                            <tr>
                                ...
                                <td class="col-action">
                                        <a class="btn btn-primary edit" title="Edit" data-toggle="modal"
                                            data-target="#commdetails_" data-id="{{ $row->id }}" data-categeory_name="{{ $row->categeory_name }}" >
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Add Categeory</h5>
                ...
                <div class="modal-body">
                    <form id="signupForm" class="needs-validation" novalidate="" method="POST"
                        action="{{ route('otherincome.otherIncomecategeoryStore') }}">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" id="categeory_name" name="categeory_name"
                                                     value="{{ old('categeory_name') }}" required />
                                                <p style="color:Tomato"> 
                                                    @error ('categeory_name'){{ $message }} 
                                                    @enderror
                                                </p>
                                            </div>
                                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-stage').on('click', '.edit', function() {
            ...
            $('#categeory_name').val($(this).attr('data-categeory_name'));
