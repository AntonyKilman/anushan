                        ...
                        <div class="card-body">
                            <form action="/service-charge-Store" method="post" class="needs-validation" novalidate=""
                                ...
                                <div class="card-body form">
                                   ...
                                   <input type="hidden" class="form-control" name="id" value="{{ $editDatas->id }}">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control editAmount" name="amount" step="0.001"
                                                    id="editAmount" value="{{ $editDatas->amount }}" readonly>
                                                <span class="text-danger">
                                                    @error('amount')
                                                        {{ $message }}
                                                    @enderror
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="invoice_no"
                                                    id="editinvoice_no" value="{{ $editDatas->invoice_no }}" readonly>
                                                <span class="text-danger">
                                                    @error('invoice_no')
                                                        {{ $message }}
                                                    @enderror
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label>Month</label>
                                                <input type="month" class="form-control"  value="{{ $editDatas->month }}"  max="{{Carbon::now()->format('Y-m')}}" name="month" readonly>
                                                <span class="text-danger">
                                                    @error('month')
                                                        {{ $message }}
                                                    @enderror
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="editNote"
                                                    name="note" readonly>{{ $editDatas->note }}</textarea>
                                                <span class="text-danger">
                                                    @error('note')
                                                        {{ $message }}
                                                    @enderror
                                  ...
                                  <div align="right">
                                  <a href="{{ route('account.serviceChargeShow') }}" class="btn btn-sm btn-danger ">
                                    <i class="fas fa-close-right"></i> Close
...
{{--
                                    ...
                                    <button class="btn btn-danger mr-1"  type="close">Close</button>
