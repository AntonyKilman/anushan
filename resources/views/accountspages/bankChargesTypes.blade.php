...
@section('bank_charges_types', 'active')
@section('content')
    <?php
                    ...
                    <div class="card">
                        <div style="padding: 10px;">
                            ...
                            <div class="card-header-bank">
                                <h4 class="header ">Bank Charge Types</h4>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        @foreach ($bankChargesTypes as $bankChargesType)
                                            <tr>
                                                <td style="display: none">#</td>
                                                <td>{{ $bankChargesType->name }}</td>
                                                <td>{{ $bankChargesType->description }}</td>

                                                <td style="text-align: center">
                                                    <button data-toggle="modal" data-id="{{ $bankChargesType->id }}"
                                                        data-name="{{ $bankChargesType->name }}"
                                                        data-description="{{ $bankChargesType->description }}"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Bank Charge Types</h5>
                ...
                <div class="modal-body">
                    <!-- Main Content -->
                    <form action="/bank-chargestype-store" method="post" class="needs-validation" novalidate="">
