...
@section('content')
    <!-- Main Content -->
    <a href="/sales/sales-cancel-report" class="btn btn-info">Back</a>
    <div class="card-body">
      <div>
            ...
            <table class="table">
                ...
                <div class="">
                    <tr>
                        ...
                        <td><h5 style="margin:0px;padding:0px;">{{number_format($totalBill,2)}}</h5></td>
                    </tr>
                </div>
              </table>
          </div>
...
<script>
  ...
  function reprintBill(invoiceNo, date, time){
      ...
      var printHtml = '<div style="border-bottom:0.2px solid black;display:flex;flex-direction:column;align-items: center;"><img src="https://www.foodcity.reecha.lk/assets/img/reecha1.png" alt="" width="100"/><div style="font-size:13px"></div><div></div><div style="width:100%;margin-left:30px;margin-bottom:10px;font-size:12px;"><div>Date: '+ date +' </div><div>Time: '+ time +'</div><div>Invoice No: '+ invoiceNo +'</div></div></div>' + $('#reprint-area').html() + '<div style="padding-top:10px;display:flex;flex-direction:column;align-items: center;"><div>Thank You</div></div>';
