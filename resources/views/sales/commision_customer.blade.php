...
@section('CommisionCustomer', 'active')
@section('content')

    <div class="card card-success">
        <div class="card-header">
            <h4>Commision Customer</h4>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                    ...
                    <tbody>
                        @foreach ($commisioncustomer as $row)
                            <tr>
                                ...
                                <td class="col-action">
                                        <a class="btn btn-primary edit" title="Edit" data-toggle="modal"
                                            ...
                                            data-name="{{ $row->name }}" data-phone_number="{{ $row->phone_number }}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="formModal">Create Commision Customer</h5>
                ...
                <div class="modal-body">
                    <form id="signupForm" class="needs-validation" novalidate="" method="POST"
                        action="{{ route('commisioncustomer.commision_customer_create') }}">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="customer phone number"> Phone Number<span class="text-danger">*</span></label>
                                            <div>
                                                <input type="number" class="form-control" id="phonenumber" name="phonenumber"
                                                    placeholder="Enter the  Phone Number" value="{{ old('phonenumber') }}" required />
                                                <p style="color:Tomato"> 
