...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="header">Sales Product Stock Adjustment </h4>
        </div>
        <div class="card-body">
        <form action="/sales_stock_view/adjustment" method="get">
            @csrf
            ...
            {{-- <div class="card-body form"> --}}
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="product_sub_cat_id" id="product_sub_cat_id" class="form-control">
                                ...
                                <td style="text-align: center">
                                    <button data-toggle="modal"
                                     data-product_id="{{ $item->item_id }}"
                                        ...
                                        data-pur_item_qty_type="{{ $item->scale_id }}"
                                    ...
                                    <button data-toggle="modal" data-type="edit"
                                    data-product_id="{{ $item->item_id }}"
                                        data-product_name="{{ $item->name }}"
                                        data-pur_item_qty_type="{{ $item->scale_id }}"
                                        data-FINAL_STOCK_AMOUNT="{{ $item->FINAL_STOCK_AMOUNT }}"
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <form action="/sales-adjustment-store" method="post" class="needs-validation" novalidate="">
                            <div class="row">
                                <div class="col-4">
                ...
                success: function(data) {
                    ...
                    $.each(data, function(index, element) {
                        ...
                        if (type) {
                            ...
                            modal_tbody +=
                                `<tr>
                                <td><input type="text" class="form-control" readonly value="${element.name}"> </td>
                                <td style="display:none"><input type="text"  value="${element.item_id}" name="product_id[]"></td>
                                <td style="display:none"><input type="text"  value="${element.food_city_product_id}" name="food_city_product_id[]"></td>
                                <td><input type="text" class="form-control" readonly value="${element.scale_id}" name="qty_type[]"></td>
                                ...
                                <td><input type="checkbox" class="form-control w-50" name="${element.item_id}-${element.purchase_order_id}"></td>
                            </tr>`;
                            ...
                            modal_tbody +=
                                `<tr>
                                <td><input type="text" class="form-control" readonly value="${element.name}"> </td>
                                <td><input type="text" class="form-control" readonly value="${element.scale_id}" name="product_id[]"></td>
                                <td><input type="number" class="form-control" readonly value="${element.purchase_order_id}" name="purchase_id[]"></td>
