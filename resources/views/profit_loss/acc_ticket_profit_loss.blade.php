...
@section('account_profit_loss_ticket', 'active')
@section('content')
                    ...
                    <div class="card">
                        <div style="padding: 10px;">
                            ...
                            <div class="card-header-bank">
                                <h4 class="header ">Ticket<br>Income Statement for Ending {{ $to }}</h4>
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tdWidth"></td>
                                                    ...
                                                    <td class="tdWidth tdBold tdright">
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td class="borderTd tdBold tdright">(0.00)
                                            </td>
                                        ...
                                        <tr>
                                            <td>Stock at {{ $from }}</td>
                                            <td></td>
                                            <td class="tdBold tdright">0.00</td>
                                            <td></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>-Stock at {{ $to }}</td>
                                            <td></td>
                                            <td class="borderTd tdBold tdright">(0.00)</td>
                                            <td class="borderTd tdright">({{ number_format($FINAL_PURCHASE, 2) }})</td>
                                        </tr>
