...
class CreateInventoryIndoorReturnsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inventory_indoor_returns', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('inventory_indoor_returns');
    }
}
